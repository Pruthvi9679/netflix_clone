        ...
        bottomNavigationBar: BottomNavigationBar(
          ...
          items: [
            BottomNavigationBarItem(
                icon: Icon(
                  Icons.home_filled,color:Colors.red,
                ),
                label: "Home"),
            BottomNavigationBarItem(
                icon: Icon(
                  CupertinoIcons.game_controller,color:Colors.red,
                ),
                label: "Games"),
            BottomNavigationBarItem(
                icon: Icon(
                  Icons.video_library_outlined,color:Colors.red,
                ),
                label: "News & Hot"),
            BottomNavigationBarItem(
                icon: Icon(
                  CupertinoIcons.arrow_down_circle,color:Colors.red,
                ),
                label: "Download"),
          ],
        ),
